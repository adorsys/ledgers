...
public class DepositAccountTO {
    ...
    private AccountStatusTO accountStatus = AccountStatusTO.ENABLED;
    ...
    private AccountUsageTO usageType;
    /*
    ...
    public DepositAccountTO() {
    }

    public DepositAccountTO(String id, String iban, String bban, String pan, String maskedPan, String msisdn, Currency currency, String name, String product, AccountTypeTO accountType, AccountStatusTO accountStatus, String bic, String linkedAccounts, AccountUsageTO usageType, String details) {
        this.id = id;
        this.iban = iban;
        this.bban = bban;
        this.pan = pan;
    ...
    public AccountUsageTO getUsageType() {
        return usageType;
    }

    public void setUsageType(AccountUsageTO usageType) {
        this.usageType = usageType;
    }
