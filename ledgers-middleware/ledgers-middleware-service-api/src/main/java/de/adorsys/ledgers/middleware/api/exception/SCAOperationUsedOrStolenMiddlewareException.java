...
public class SCAOperationUsedOrStolenMiddlewareException extends Exception {
    ...
    public SCAOperationUsedOrStolenMiddlewareException(String message) {
        super(message);
    }

    public SCAOperationUsedOrStolenMiddlewareException(Throwable cause) {
        super(cause);
    }

    public SCAOperationUsedOrStolenMiddlewareException(String message, Throwable cause) {
        super(message, cause);
    }
}