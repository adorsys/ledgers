...
public interface ScaVerificationRestAPI {
    ...
    @Operation(value = "Send email for verification", authorizations = @Authorization(value = "apiKey"))
    @ApiResponses(value = {
    ...
    @GetMapping("/email")
    @Operation(tags = UnprotectedEndpoint.UNPROTECTED_ENDPOINT, value = "Confirm email")
    @ApiResponses(value = {
