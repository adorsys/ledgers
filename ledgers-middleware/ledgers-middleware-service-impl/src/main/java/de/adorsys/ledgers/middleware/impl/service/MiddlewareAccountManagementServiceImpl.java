...
public class MiddlewareAccountManagementServiceImpl implements MiddlewareAccountManagementService {
    ...
    public MiddlewareAccountManagementServiceImpl(DepositAccountService depositAccountService,
                                                  ...
                                                  UserService userService, UserMapper userMapper, AisConsentMapper aisConsentMapper, AccessTokenTO accessToken, Principal principal) {
    ...
    @Override
    public void createDepositAccount(String accountNumberPrefix, String accountNumberSuffix, AccountDetailsTO
                                                                                                     accDetails)
    ...
    // Validate that
    private void validateInput(List<DepositAccountBO> accounts, String accountNumberPrefix, String
                                                                                                    accountNumberSuffix) throws AccountWithPrefixGoneMiddlewareException, AccountWithSuffixExistsMiddlewareException {
        ...
        // TODO Francis please explain what is this logic doing? The result of forEach+contains is not somehow used!
