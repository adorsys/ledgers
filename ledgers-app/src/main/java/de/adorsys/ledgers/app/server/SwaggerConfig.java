...
public class SwaggerConfig {
    ...
    @Bean
    public Docket mockBankDataTestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
           .groupName("002 - MOCKBANK DATA TEST API")
           .select()
           .apis(RequestHandlerSelectors.withClassAnnotation(EnableMockBankSimpleDataTest.MockBankSimpleDataTestResource.class))
           .paths(PathSelectors.any())
           .build()
           .pathMapping("/")
           .apiInfo(metaData());
