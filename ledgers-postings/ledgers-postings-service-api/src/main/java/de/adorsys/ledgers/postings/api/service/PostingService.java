...
public interface PostingService {
    ...
    PostingLineBO findPostingById(LedgerAccountBO ledgerAccount, String sourceId) throws LedgerAccountNotFoundException, LedgerNotFoundException, PostingNotFoundException;
}
