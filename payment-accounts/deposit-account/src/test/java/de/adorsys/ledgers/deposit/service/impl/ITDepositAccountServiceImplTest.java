...
public class ITDepositAccountServiceImplTest extends DepositAccountServiceImpl {
	...
	public void test_create_customer_bank_account_ok() throws NotFoundException {
		...
		String ledgerName="Ledger-Deposit";
		String depositParentAccountNumber = "Deposits";
		DepositAccount createdDepositAccount = depositAccountService.createDepositAccount(da, ledgerName, depositParentAccountNumber);
